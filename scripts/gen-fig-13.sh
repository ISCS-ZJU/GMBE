...
do
  ...
  ./bin/MBE_GPU -i "${dataset_file}" -s 5 -t 1 -o 1 -x 1 -f | tee ${result_file} | grep "Processing time of gpu" | awk -F ':' '{printf "%s \n", $2}' | grep '[0-9.]*' -o | sort -n | awk  '{printf "%s ", $0}'  >> "$data_file"
  ...
  ./bin/MBE_GPU -i "${dataset_file}" -s 5 -t 1 -o 1 -x 2 -f | tee ${result_file} | grep "Processing time of gpu" | awk -F ':' '{printf "%s \n", $2}' | grep '[0-9.]*' -o | sort -n | awk  '{printf "%s ", $0}'  >> "$data_file"
  ...
  ./bin/MBE_GPU -i "${dataset_file}" -s 5 -t 1 -o 1 -x 4 -f | tee ${result_file} | grep "Processing time of gpu" | awk -F ':' '{printf "%s \n", $2}' | grep '[0-9.]*' -o | sort -n | awk  '{printf "%s ", $0}'  >> "$data_file"
  ...
  ./bin/MBE_GPU -i "${dataset_file}" -s 5 -t 1 -o 1 -x 8 -f | tee ${result_file} | grep "Processing time of gpu" | awk -F ':' '{printf "%s \n", $2}' | grep '[0-9.]*' -o | sort -n | awk  '{printf "%s ", $0}'  >> "$data_file"
